...
Tạo Collection `Inventory Service` (đã export sẵn ra file `Inventory_Service.postman_collection.json`).
...
|---|---|---|---|---|---|
| 1 | Đủ hàng | skuCode=iphone_15, quantity=100 | 200 | true | [x] Đạt |
| 2 | Không đủ hàng | skuCode=iphone_15, quantity=200 | 200 | false | [x] Đạt |
| 3 | Boundary `=` tồn kho | skuCode=pixel_8, quantity=100 | 200 | true | [x] Đạt |
| 4 | Boundary vượt 1 đơn vị | skuCode=pixel_8, quantity=101 | 200 | false | [x] Đạt |
| 5 | SKU không tồn tại | skuCode=not_exist_sku, quantity=1 | 200 | false | [x] Đạt |
| 6 | Thiếu `quantity` | skuCode=iphone_15 | 400 | — | [x] Đạt |
| 7 | Thiếu `skuCode` | quantity=10 | 400 | — | [x] Đạt |
| 8 | Sai kiểu `quantity` | quantity=abc | 400 | — | [x] Đạt |
| 9 | `quantity` âm | quantity=-5 | 200 (hiện tại) / nên 400 | true (hiện tại) | [x] Đạt (ghi nhận) |
| 10 | Sai method (POST) | — | 405 | — | [x] Đạt |

- [x] Export Postman Collection ra file `.json` để lưu lại (`Inventory_Service.postman_collection.json`)
